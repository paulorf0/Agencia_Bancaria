...
public class MenuContaSalario {
    ...
    public static void exibirMenu(Scanner scanner, ContaSalario contaSalario, Canal canal) {
        ...
        while (executando) {
            ...
            switch (opcao) {
                ...
                case "4":
                    ...
                    try {
                        contaSalario.transferir(CPF, valorTransferencia, canal);
                    } catch (SaldoException e) {
                        System.out.println(e.getMessage());
                    }
                ...
                case "5":
                    ...
                    try {
                        contaSalario.efetuarPagamento(CPF, valorPagamento, canal);
                    } catch (SaldoException e) {
                        System.out.println(e.getMessage());
                    }
