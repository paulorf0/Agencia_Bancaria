        ...
        for (Cliente cliente : clientes) {
            if (cliente.getCpf() != null && cliente.getCpf().equals(cpf)) {
                ...
                if (conta != null && conta.getSenha() != null && conta.getSenha().equals(senha)) {
                    ...
                    // Redirecionar para o menu específico da conta
                    if (conta instanceof ContaCorrente corrente) {
                        MenuContaCorrente.exibirMenu(scanner, cliente, corrente);
                    } else if (conta instanceof ContaPoupanca poupanca) {
                        MenuContaPoupanca.exibirMenu(scanner, cliente, poupanca);
                    } else if (conta instanceof ContaSalario salario) {
                        MenuContaSalario.exibirMenu(scanner, cliente, salario);
                    } else {
